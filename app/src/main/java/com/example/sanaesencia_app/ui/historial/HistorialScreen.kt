...
fun HistorialScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            // Botón de demostración: dispara el motor de alertas predictivas (WorkManager)
            // de inmediato, sin esperar el ciclo periódico de 15 minutos. Útil para
            // mostrar en clase que la notificación push realmente se genera.
            Button(
                onClick = { WorkScheduler.ejecutarChequeoAhora(context) },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = 16.dp)
            ) {
                Text("Simular chequeo de alertas ahora")
            }
